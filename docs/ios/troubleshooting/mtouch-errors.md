...
description: Bu belgede mtouch, Xamarin.iOS uygulamaları gruplamak için kullanılan aracı tarafından oluşturulan çeşitli hatalar açıklanır. Hata koduna göre listelenen ve tam açıklama verilir.
