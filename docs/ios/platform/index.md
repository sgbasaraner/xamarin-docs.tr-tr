...
##  <a name="introduction-to-ios-11iosplatformintroduction-to-ios11indexmd"></a>[İOS 11 giriş](~/ios/platform/introduction-to-ios11/index.md)

Yükleme ve Xcode 9 beta ve Xamarin'ın iOS 11 desteği önizlemesini kullanmaya başlama hakkında.


##  <a name="introduction-to-ios-10iosplatformintroduction-to-ios10indexmd"></a>[İOS 10 giriş](~/ios/platform/introduction-to-ios10/index.md)
...
##  <a name="introduction-to-ios-9iosplatformintroduction-to-ios9indexmd"></a>[İOS 9 giriş](~/ios/platform/introduction-to-ios9/index.md)
...
##  <a name="introduction-to-ios-8iosplatformintroduction-to-ios8md"></a>[İOS 8 giriş](~/ios/platform/introduction-to-ios8.md)

Apple iOS 8, iOS 7 işletim sistemine çok sayıda değişiklik yaptınız. Burada, bunların ne olduğunu ve bunların nasıl kullanılacağını gösterir.

##  <a name="introduction-to-ios-7iosplatformintroduction-to-ios7indexmd"></a>[İOS 7 giriş](~/ios/platform/introduction-to-ios7/index.md)
...
##  <a name="introduction-to-ios-6iosplatformintroduction-to-ios6indexmd"></a>[İOS 6 giriş](~/ios/platform/introduction-to-ios6/index.md)
...
##  <a name="contacts-and-contactsuiiosplatformcontactsmd"></a>[Kişiler ve ContactsUI](~/ios/platform/contacts.md)
...
##  <a name="ios-gaming-apisiosplatformgamingindexmd"></a>[iOS oyun API'leri](~/ios/platform/gaming/index.md)
...
##  <a name="multitasking-for-ipadiosplatformmultitaskingmd"></a>[İPad için çoklu](~/ios/platform/multitasking.md)
...
##  <a name="search-apisiosplatformsearchindexmd"></a>[Arama API'leri](~/ios/platform/search/index.md)
...
##  <a name="wide-coloriosplatformwide-colormd"></a>[Geniş rengi](~/ios/platform/wide-color.md)
...
##  <a name="binding-objective-cbinding-objective-cindexmd"></a>[Objective-C bağlama](binding-objective-c/index.md)
...
## <a name="embedded-frameworksembedded-frameworksmd"></a>[Katıştırılmış çerçeveler](embedded-frameworks.md)
