...
> [!IMPORTANT]
>  **Not:** grafik bağlam yapılan değişiklikler tüm sonraki çizim işlemleri için uygulanır. Bu nedenle, CTM dönüştürüldüğünde herhangi bir ek çizim etkiler. Örneğin, CTM dönüştürme işleminin ardından üçgen u çizdiğini, ters görünür.
