...
##### [Mac’e Bağlanma](get-started/installation/windows/connecting-to-mac/index.md)
###### [Bağlantı Sorunlarını Giderme](get-started/installation/windows/connecting-to-mac/troubleshooting.md)
###### [Mac’im Nerede?](get-started/installation/windows/connecting-to-mac/visual-studio-ssh.md)
##### [El ile Yükleme](get-started/installation/windows/manual-installation.md)
