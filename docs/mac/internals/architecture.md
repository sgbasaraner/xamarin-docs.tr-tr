...
[![Mimariyi temel bir bakış gösteren diyagram](architecture-images/mac-arch.png "mimariyi temel bir bakış gösteren diyagram")](architecture-images/mac-arch-large.png)
