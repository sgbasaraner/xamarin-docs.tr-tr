...
description: Bu başvuru kılavuzunda çeşitli öznitelikler ve C# Objective-C kitaplıkları bağlamalar oluştururken anlamanız gereken kavramlar açıklanır.
ms.prod: xamarin
