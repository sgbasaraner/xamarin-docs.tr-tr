...
#### [Windows Sisteminde Visual Studio’da Xamarin’i Yükleme](get-started/installation/windows.md)
...
#### [Genel bakış](app-fundamentals/building-cross-platform-applications/part-0-overview.md)
#### [Bölüm 1 - Xamarin Mobil Platformunu Anlama](app-fundamentals/building-cross-platform-applications/part-1-understanding-the-xamarin-mobile-platform.md)
#### [Bölüm 2 - Mimari](app-fundamentals/building-cross-platform-applications/part-2-architecture.md)
#### [Bölüm 3 - Xamarin Platformlar Arası Çözümünü Ayarlama](app-fundamentals/building-cross-platform-applications/part-3-setting-up-a-xamarin-cross-platform-solution.md)
#### [Bölüm 4 - Birden Fazla Platformla İlgilenme](app-fundamentals/building-cross-platform-applications/part-4-platform-divergence-abstraction-divergent-implementation.md)
#### [Bölüm 5 - Pratik Kod Paylaşma Stratejileri](app-fundamentals/building-cross-platform-applications/part-5-practical-code-sharing-strategies.md)
#### [Bölüm 6 - Test Etme ve App Store Onayları](app-fundamentals/building-cross-platform-applications/part-6-testing-and-app-store-approvals.md)
...
### [Bağlı Hizmetler](data-cloud/connected-services.md)
### [Azure Active Directory](data-cloud/active-directory/index.md)
#### [Başlarken](data-cloud/active-directory/get-started/index.md)
##### [1. Adım Yazmaç](data-cloud/active-directory/get-started/register.md)
##### [2. Adım Yapılandırma](data-cloud/active-directory/get-started/configure.md)
#### [Graph API’ye Erişme](data-cloud/active-directory/graph.md)
### [Azure Mobile Apps](data-cloud/mobile-apps.md)
### [Web Hizmetlerine Giriş](data-cloud/web-services/index.md)
#### [İzlenecek Yol - WCF ile Çalışma](data-cloud/web-services/walkthrough-working-with-wcf.md)
...
## [İç İşlevler](internals/index.md)
### [Kullanılabilir Bütünleştirilmiş Kodlar](internals/available-assemblies.md)
