...
description: Bu kılavuz, Visual Basic.NET dilinde yazılan iş mantığı kullanan yerel Xamarin.iOS ve Xamarin.Android uygulamalar oluşturmak gösterilmiştir.
ms.prod: xamarin
