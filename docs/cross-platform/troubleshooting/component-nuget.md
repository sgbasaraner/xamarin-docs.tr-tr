...
description: Bu belgede Xamarin bileşen Deposu'nda kullanımdan bu yana bileşen başvuruları gelecekteki sağlaması için NuGet paketleri ile uygulamalarınızı nasıl değiştirileceği açıklanmaktadır.
...
Popüler Xamarin listesini [eklentileri ve kitaplıklarını](https://github.com/xamarin/XamarinComponents/blob/master/README.md) NuGet paketleri olarak kullanılabilir olan bileşenleri alternatifleri bulmak kullanılabilir.
