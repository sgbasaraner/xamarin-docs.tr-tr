...
|[AMP kurumu](https://www.ampagency.com/)|Los Angeles, CA, ABD; Boston, MA, ABD|AMP Ajans yazılım geliştirme ve pazarlama hizmetleri sağlar.|
...
|[Fino LLC danışmanlık](http://www.finoconsulting.com)|New York, NY|Pazarınızda Rekabetin gerekiyor, işletmenizi Araçlar sunan Fino danışmanlık yapılar olağanüstü yazılım|
...
|[Leaware](http://www.leaware.com)|Elmhurst, IL; Monheim Rhein, Almanya 'M; Varşova, Polonya|Bir yazılım Merkezi, şirket ve geliştirme kesin - uzmanlaşmış yerel, çok platformlu mobil uygulamalarda ve web uygulamaları tasarım Leaware olur. Bizim benzersiz yeteneklerini uzmanlıklar, blend ve deneyimini bize en gelişmiş ve güvenilir çözümleri piyasadaki hemen oluşturmanıza yardımcı olur.|
...
|[CommerceLab](http://www.commercelab.com.au)|Sydney, Avustralya|Küçük işletmeler, çevrimiçi ve çevrimdışı, modern Market'te rekabet gücüne bizim Sidney tabanlı uygulama geliştirmeyi getirir|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Apcurium](http://www.apcurium.com)|Montreal, Kanada|Apcurium bugün mobil cihazları, platformlar ve teknolojiler belirli iş stratejiler ve kullanıcıların beklentilerini bağlanan mobil çözümleri geliştiriyor.|
|[BSI Laboratuvarları](https://bsilabs.ca/)|Toronto, Kanada|BSI Labs uzmanlaşmış bir hizmet geliştiriciliğe mobil stratejisi, UX/UI tasarım, mobil uygulama geliştirme ve tümleştirme sistemleri kullanılabilir.|
|[Clearbridge mobil](https://clearbridgemobile.com/)|Toronto, Kanada|Clearbridge mobil kullanıcı merkezli ürün tasarımı ve mühendislik hizmetleri sağlayan bir ödüllü tam yığın mobil uygulama geliştirme şirkettir|
|[Bilişsel X Solutions Inc.](http://cognitivex.com)|Moncton, Kanada|Web ve mobil deneyimler ekliyoruz |
|[Cortex medya](http://cortex.bz)|Quebec, Kanada|Gerçek ve sanal, bağlanan mobil platformları işletmelerin ve kişiler cortex medya tasarımları|
...
|[nventive](http://www.nventive.com)|Montreal, QC|iOS, Android ve en son teknolojileri kullanarak Windows 10 için mobil uygulama geliştirmeye modern bir studio nventive olur.|
|[ObjectSharp Corporation](http://www.objectsharp.com)|Toronto, Kanada|İlk Microsoft .NET danışmanlık ortağı olarak Kanada'da, ObjectSharp, tüm Microsoft özel geliştirme, eğitim ve hizmetler için rehberliği sunabilir: bilgisayar ve Tablet ' Äì Windows 8 + 7, Windows Phone ' Äì Windows Phone, bulut ' Äì Azure. Microsoft MVPs, Kıdemli yazılım geliştiricilerine ve deneyimli eğitmenler, tasarlama, oluşturma ve uygulamaları daha hızlı ve daha iyi yardımcı olur.|
|[Panoramik yazılım](http://www.panoramicsoft.com)|Surrey, İngiliz Kolumbiyası|  Panoramik yazılım Inc. stratejik mobil yazılım başlıkları sosyal, eğitim, müzik ve oyun pazarlara 2006 katıldığımdan. |
|[RedBit geliştirme](http://www.redbitdev.com)|Toronto, Kanada|RedBit geliştirme sürücüsü olan yeni kitlelere ulaşın ve gelir kanalları oluşturun ve marka bilinirliğinizi artırın şirketlerin yazılım ürünleri ve çözümleri sunmaya odaklanmasını bir yazılım danışmanlığı ve tasarım şirketidir. Bunlar, işletmeniz hakkında öğrenme, işlemlerinizin Çincesi ve teknoloji uygun ise olacağı belirlenirken odaklanın. Bir mobil göre web tabanlı bir çözüm, tasarım veya bir uçtan uca sistemin tamamı, bunların hedef sonuçları vermesi için iş ortağı çözümdür olması.|
|[SDA yazılım Associates Inc.](http://www.sda.com)|Vancouver, BC|Web ve mobil geliştiriciliğe, kullanışlı ve güvenilir yazılım kaynaklı hakkında tutkulu duyuyoruz. İlgi çekici ve ilgili web ve mobil deneyimler sağlayarak marka tanıma ve sadakatini artırın müşterilerimizin yardımcı olabiliriz.|
|[Webility Solutions Inc.](http://webility.ca)|Hamilton, ON, Kanada|Yarı özel web, mobil ve IOT çözümleri işletmenizi iyileştirin. Uzman geliştiricilerden oluşan Webility'nın takım hızlı pazara daha hızlı sonuçlar için kişiselleştirilmiş yazılım çözümleri oluşturun.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Yazılımı yüksek görüntüleyin](http://www.highviewsoft.com)|Beijing, Çin|Platformlar arası uygulama ve bulut tabanlı hizmet programı tasarım, geliştirme, uygulama, bir teknik eğitim ve diğer danışmanlık hizmetleri sağlamaya Visionsoft yazılım odaklanma|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[IDlink](http://www.idlink.co)|Medellín, Kolombiya|Bir danışmanlık IDlink ise ve yazılım geliştirme şirketi geliştirerek otomatik kimlik ve veri yakalama (AIDC) çözümleri ilgili RFID ve barkod teknolojisini temel alan özel|
|[WorkApps](http://www.workapps.com.co/)|Bogota, Kolombiya|WorkApps Ulusal University Kolombiya, sistemleri mühendisi mezunu tarafından kurulan Kolombiya bir şirkettir. Hizmet geliştirilen ürünlerinde yenilik oluşturur.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Apptividad](http://apptividad.com/)|San Jose, Kosta Rika|İş veya marka web kanallar aracılığıyla daha fazla Etkilenme Apptividad sağlayabilir AR ve mobil uygulamalar; güçlü API tümleştirmesi iç sistemler ve iş ortakları için de kullanabilirsiniz.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Datatech BT ile Çözümleri LTD](http://www.datatech.com.cy)|Kıbrıs|Datatech BT ile Çözümleri Ltd bir teknoloji çözümlerini Kuruluş İçerik Yönetimi, tedarik zinciri yönetimi ve mobil çözümler alanlarında önde gelen sağlayıcıdır|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[DevMasters](http://www.devmasters.cz/)|Prag, Çek Cumhuriyeti|DevMasters çözüm ve uygulamalar geliştirmeye odaklı bir Çekçe BT şirkettir|
...
|[Bluefragments](http://www.bluefragments.com)|Kopenhag, Danimarka|Bluefragments uygulama geliştirme konusunda uzmanlaşmış ve sertifikalı bir Microsoft iş ortağıdır.|
|[AP Comet.dk (CometPeople)](http://comet.dk)|Kopenhag, Danimarka|Comet olduğu gibi iPhone, en son mobil platformlara mobil uygulamaların geliştirilmesini sağlayan bir Geliştirme Merkezi iPad, Android ve Windows Phone|
|[Commentor DK](http://commentor.dk)|Aalborg, Danimarka|Danimarka içinde en büyük şirketler için Görev açısından kritik uygulamaların 2000 sağlanan commentor sahiptir.|
|[Miracle](https://miracle.dk/)|Ballerup, Danimarka|Miracle biz Danimarka dijital bizim katkı sağlamak için hedeflenir. En yüksek kalite sağlayarak bunu BT çözümleri için özel ve genel şirketler Danimarka etrafında 3 bizim konumlardan|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Maven S.R.L.](http://www.maven.do)|Dominik Cumhuriyeti|Maven ile büyük hayallerini küçük bir şirkettir. 2012'de, yeni teklif, Dominik Cumhuriyeti, kalite ve çeşitli yazılım çözümleri en iyi bir yolu olarak kurulmuştur. Müşterilerimiz ile yazılım geliştirme garantili kaliteyi sağlamak ve bunu yaparken, güven ve Sorumluluk kendi necessities doğru bir ilişki teşvik hedeflenir.|
|[Solvex Dominicana](http://www.solvex.com.do)||Mesleki deneyime Solvex değerleri. 2014'te kurulan şirket, artık hangi üzerinde yüzde 80'i yazılım teslim deneyiminin en az 5 yıl sahip 200 yazılım mühendisleri sahiptir. |
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[ITWorx](http://www.itworx.com)|Kahire, Mısır|ITWORX dünyanın önde gelen kuruluşlara Otomasyona odaklanarak Advanced Analytics, Enterprise Mobility, performansı yönetimi ve CRM için bulut tabanlı ve şirket içi çözümler sağlayan küresel BT Hizmetleri firmasıdır.|
|[Jios geliştirme](https://www.jiosdev.com/)|Mısır|Jios geliştirme teknoloji danışmanlığı sağlayarak ve Hizmetleri özel uygulama geliştirme, bulut Hizmetleri ve mobil uygulamaları uzmanlaşmış dış kaynak bir kararlı hızlı büyüyen bir şirkettir. |
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Altran Fransa](http://www.altran.fr/)|Paris, Fransa|Mühendislik ve ar -ge Hizmetleri dünya lideri Altran olduğu|
|[Arolla](http://www.arolla.fr/)|Paris, Fransa|Yazılım geliştirmenin en gelişmiş teknikleri bir danışmanlık şirketi özelleştirilmiş Arolla olur.|
|[Cellenza](http://www.cellenza.com)|Paris, Fransa|Teknik uzmanlığı ve uygulaması, Microsoft teknolojisi ve çevik yöntemler için özel olarak ayrılmış bir geliştiriciliğe Cellenza olduğu|
|[Chloro](http://www.chloro.eu)|Selestat, Fransa|Tasarım ve üretkenlik ve yanıt hızını kazanç getirmek için hedeflenir özelleştirilmiş bir mobil uygulama geliştirme sürecini Chloro uzmanlaşmış|
|[DevoTeam grubu](http://www.devoteam.com)|Paris, Fransa|Biz Devoteam yenilikçi teknoloji iş için danışmanlık sunun|
|[Exakis](http://www.exakis.com)|Paris, Fransa|Exakis şirketlere yenilikçi projeler ve bilgi sistem güvenliği geliştirmek için yardımcı olur. Kullanıcı Odaklı Tasarım ve yenilik birleştiren Microsoft teknolojilerini temel alan çözümleri geliştirme|
|[Ideine](http://ideine.fr/en/ideine/)|Roubaix, Fransa|Çapraz geliştirme uzmanı, Ideine tasarlar ve özelleştirilmiş, yenilikçi ve etkili mobil uygulamalar geliştirir.|
|[Sonsuz kare](http://www.infinitesquare.com)|Paris, Fransa|Sonsuz kare görev tasarlayın ve yenilikçi yazılım uygulamaları ve daha iyi kalite müşterileri, küçük ve büyük ölçekli işletmeler, güven ve kazanan birlikte en iyi ilişkisinde adına üretmek sağlamaktır.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[27interactive](http://27interactive.com)|Düsseldorf, Almanya; Hamburg, Almanya|Üreticiler akıllı telefonlar ve tabletler ile Android, iOS, Windows ve macOS için platform çözümleri çapraz|
|[BEKLE](http://www.aitgmbh.de)|Stuttgart, Almanya|BEKLE, .NET platformu ve daha fazlasını uzmanlaşmış yazılım danışmanları ve önde gelen geliştiricilerinin biridir. Bu, çok ödül kazanma Microsoft Gold ortak yıllardır olmuştur.|
|[Tüm Ashley GmbH hakkında](http://www.a-gentur.de)|Ibbenbueren, Almanya|Ashley hakkında destekler şirketler tasarım ve çeşitli BT çözümlerinden iyileştirme.|
|[BRICKMAKERS GmbH](http://www.brickmakers.de)|Koblenz, Almanya|Tüm Brickmakers etkinlikler için proje üzerinde odağı olan ' Äôs başarı ve avantajı. Kendi Çevik eylemi nedeniyle süreçlerinin sırasında müşteri için en fazla saydamlık verilir. Aralıkları kavramı, tasarım ve geliştirme yanı sıra, bunlar da gladly kendi portalları ve pazarlama uygulamaları sorumluluğunu. Bu dijital ürün tam yaşam döngüsü ile kendi deneyimleri getirmek bunları sağlar.|
|[BTC AG](http://www.btc-ag.com )|Oldenburg, Almanya|Yeni çözümleri geliştirin ve standart belirttiğiniz|
|[CATIS](http://www.catis.de/)|Wolfsburg, Almanya; Gifhorn, Almanya; Hanover, Almanya; Sindelfingen, Almanya; Ingolstadt, Almanya; AJAX, Kanada; Mlada Boleslav, Çek Cumhuriyeti; Chattanooga, TN|Uygulama geliştiricileri, Kurumsal Üreticiler iş ve tüketici uygulamalarına oluşturarak mobilising özellikli deneyimli bir ekibi CATIS Modern iş birimi sahiptir|
|[Cayas yazılım](http://www.cayas.de)|Minden, Almanya|Masaüstü, web yanı sıra, Android, iPad ve iPhone için uygulamalar için özel yazılım Cayas yazılım oluşturur|
|[Etkileşimli FRIDIE, Dietrich & Fritz GbR](http://fridie.de)|Stuttgart, Almanya|Özel uygulamalar ve etkileşimli yazılım için Windows, Android ve iOS ekibiyiz FRIDIE etkileşimli|
...
|[Intelligentgraphics GmbH](http://www.intelligentgraphics.biz)|Thuringia, Almanya|Satış uygulamalar için etkileşimli 3B odaklanıyoruz.|
|[ISEO çevrimiçi pazarlama GmbH](http://www.iseo.de)|Lübeck, Almanya|Peg teslim etme ancak Üçlü müşteriye değer, harika bir tasarım ve her kullanım 10 yılı aşkın için kendini kanıtlamış teknoloji konusunda uzmanlaştıktan|
|[msg sistemleri ag](http://www.msg.group/)|Berlin, Almanya; Cologne, Almanya; Hamburg, Almanya; Frankfurt, Almanya; Nuremberg, Almanya; Jersey Şehir, NJ, ABD; Basel, İsviçre; Viyana, Avusturya|ileti bir bağımsız, uluslararası 6000'den fazla çalışan yaratıcı ve stratejik danışmanlık ve akıllı, sürdürülebilir ve katma değerli BT çözümleri için geniş bir yelpazedeki bütünsel hizmet yelpazesi sunan dünyanın dört bir yanındaki şirketler grubudur sektörler.|
|[SONRAKİ Tahliye Vanasını GmbH](http://www.next-munich.com)|Münih, Almanya|Olup B2C, B2B, üretkenlik veya diğer mobil stratejileri - mobil çözümler geleceği şimdi başlar. SONRAKİ Tahliye Vanasını derinlik gider ve bir başarılı 'app-iş için' katkıda bulunan tüm malzemeleri sistematik olarak işler. SONRAKİ Tahliye Vanasını, konumlandırma ve pazarlama programlarını deneyiminin 10 yıl kullanarak mobil cihazlar için tasarım ve geliştirme, tüm bölgelerde toplar.|
|[prodot GmbH](https://prodot.de)|Duisburg, Almanya|Prodot müşterileriyle vizyonlarını olduğunu anlamıştır; bunlar el yakından istenen sonuçları eşlemek için sizinle birlikte çalışır. Sezgisel kullanıcı arabirimleri, şık tasarımları, teknolojik bilgileri ve gelecekteki sağlama çözümleri için temel öğeleridir. Kısacası, verimli döngüleri, geliştirme ihtiyaçlarınıza kararlı, karmaşık ve uzun süreli yazılım tabanlı Microsoft teknolojileri ve SAP gibi standart ürün.|
|[SDX AG](http://www.sdx-ag.de)|Frankfurt am ana Hesse, Almanya; Münih, Almanya; Bavaria, Almanya|WIR freuen seçimi, SIE bir unserem neuen Hauptsitz IM Frankfurter Westhafen begrüßen zu können. Unsere Büroräume befinden sich IM 2. OG IM Westhafenhaus, Speicherstraße 1 unmittelbar neben dem Westhafentower.|
|[SkyTest](http://business.skytest.com)|Erlangen, Almanya|Biz Xamarin™ gibi en son platformlar arası teknolojileri kullanarak özel yerel ve web tabanlı uygulamalar geliştirin. Müşterilerimizin uzun vadeli uzmanlık avantajlarından yararlanın. NET™ geliştirme ve zengin arka uç Hizmetleri.|
|[Software2Business GmbH](http://software2business.de/Service/MobileApp/EN)||Software2Business GmbH uygulamanızı – keyfini bir işbirliği ve geliştirmeye yönelik tam kapsamlı bir hizmet sunar. Bizim geliştirme işlem hattı ve araçlar bulmak, kullanırız. |
|[XITASO GmbH](http://www.xitaso.com)|Augsburg, Almanya|Danışmanlık Hizmetleri B2B müşterilere digitization potentials tanımlar, iş süreçlerini en iyi duruma getirir, dijital stratejilerini oluşturur ve geliştirdiği XITASO sağlar ve yenilikçi yazılım çözümlerini.|
|[Z√ºhlke](http://www.zuehlke.com/ch/en/)|Zürih, İsviçre; Frankfurt, Almanya; Hamburg, Almanya; De, Almanya; Münih, Almanya; Stuttgart, Almanya; Viyana, Avusturya|Ekibiyiz finansal başarılı ürünleri, hizmetleri ve işletme modellerini — fikir uygulaması aracılığıyla gelen — deneyimi, 1000 şirket içi uzmanlar ve 10. 000'den fazla başarılı projelerinin çizim tarafından.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Entersoft SA](https://www.entersoft.eu)|Kallithea, Yunanistan|Entersoft müşterileri için en iyi duruma getirilmiş verimlilik sağlamak için yenilikçi ve tam aralığını yüksek kaliteli Hizmetleri ve destek sağlayan bir önde gelen iş entreprise yazılım ve hizmetlerinin sağlayıcıdır|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Unissoft teknoloji Co., Ltd.](http://www.inas.online/en/Index.php)|Hong Kong|Çekirdek teknolojimizin arkasındaki Tsing Hua arşivleri Yönetimi yazılımını (veya kısaca TH-AMS™) önerilen durumu arşivleri yönetim Çin'de, ürünün bu nedenle uzun bir süredir., kamu tarafından da dahil olmak üzere çeşitli sektörlerde Ayrıca yaygın olarak kullanılır Petrol ve kimyasal; Sulama çalışır gibi çeşitli işletmelerde, metallurgy Telekom ve real estate and---geleneksel aracılığıyla şirket içi lisans modeli. |
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Üzümlü çözümleri](http://grape.hu/)|Budapeşte, Macaristan|2006'da kurulan bir dinamik yazılım geliştirme şirketi olan üzümlü çözümler. Biz öncelikle yerel ve uluslararası müşterilerimizin özel iş kolu uygulamaları geliştirin. |
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[GAVS teknolojileri NA dahil edilen](http://www.gavstech.com)|Chennai, Hindistan|GAVS teknolojileri bir küresel BT Hizmetleri ve çözümleri müşteriler için dikey arasında birden fazla sektör yelpazesini sağlayıcıdır|
|[Greynubo](http://www.greynubo.com/)|Singapur; Bengaluru, Hindistan|Birçok etki alanı yıllar CRM'de CPQ sahip taahhüt uzmanları ekibi GreyNubo oluşur, Salesforce platformunda güçlü bir temel ile Mobile birlikte|
|[MobMaxime](http://www.mobmaxime.com)|Ahmedabad, Hindistan |Biz, ürün VİZYONUNUZU hakkında konuşmak ve projeniz için uygun olup olmadığını size karar verin. Biz varsa, incelemeniz için bir Proje tahmini göndereceğiz.|
|[Açılan pencere teknolojileri sınırlı özel](http://www.popuptechnologies.com)|Mumbai|Açılan teknolojileri geri 5 yılda POP ve bu tarihten sonra mobil yatay üzerinde bir düzeni olmuştur. Merkezi, sahipleri Mumbai, açılan teknolojileri yeni teknolojilerle sürekli yeniden keşfetmek bir mobil çözümler şirketidir. Daha fazla 100'den fazla mobil uygulamalar - tüm platformlarda Portföyü ile iOS, Android, Windows, Xamarin, Blackberry, Html5, TIZEN ve aşamalı Web uygulamaları.|
|[Sasken iletişimi teknolojileri sınırlı](http://www.sasken.com)|Mumbai, Hindistan|Sasken nerede olurlarsa olsunlar daha iyi bağlı kalın kişiler yardımcı oluyor. Otomatik elektronik dahil olmak üzere daha fazla sektörlerde, tüketici elektroniği, perakende ve sağlık hizmetleri bulut bağlantısının gerekliliğini verilerle birlikte ve gerçek zamanlı görüyorsunuz. İletişim ve medya işleme eşsiz bir etki alanı becerilerine kritik zorluklar konusunda sektör bildirimlerini almak düzgün değildirler. Bağlı cihazların yeni ve geliştirilmekte olan ortamda üstün Hizmetleri sunmak için karşılıkları ekosistemindeki ile çalışır.|
|[ServPRO teknolojileri Pvt Ltd](http://www.servpro.in)|Mumbai, Hindistan|ServPRO, "Hizmet proaktif olarak için" temsil eden bir marka, 2009'dan Bay Pushpinder Bhatia tarafından kurulmuştur. Önde gelen BT çözümleri ve Hizmetleri Sağlayıcısı adanmış bir biçimde & Garments, perakende, Petrol ve gaz, Eczacılık, üretim, bankacılık, Agro dahil olmak üzere birçok dikey parçaları arasında iş açısından kritik ve yenilikçi BT çözümleri sunmak için ServPRO olan FMCG/CPG, Bullion, EXIM ve çeşitli diğer dikey sektör yelpazesini.|
|[Taritas yazılım çözümleri Pvt. Ltd.](http://www.taritas.com/)|Bengaluru, Karnataka, Hindistan; Jabalpur, Madhya Pradesh, Hindistan|Taritas kullanılmaya başlandı önde gelen çözümler sunan bir yazılım dış kaynak kullanımı şirketidir. Bize öncelikle proje maliyetlerini en aza indirmek ve müşterilerimizin kârını en üst düzeye odaklanan yüksek kaliteli geliştirme Hizmetleri sunmak yazılım ve uygulama geliştirme yurtdışında maliyet avantajları ile birlikte kapsamlı bilgi sağlar. Biz "ilk kez zamanında ve Bütçeyi sağ" yaklaşım izleyin. |
|[Teknik Mahindra](https://techmahindra.com)|Bengaluru|Teknik Mahindra bağlantı Dünyası, kuruluşların, ilişkilendirir ve Society Rise™ için etkinleştirme yenilikçi ve müşteri odaklı bilgi teknolojisi Hizmetleri ve çözümleri sunan temsil eder. Biz 4.4 milyar ABD Doları şirket 117,600 + uzmanları ile 90 arasında Fortune 500 şirketlerinin de dahil olmak üzere 840 + genel müşterilerin yardımcı ülkesidir.|
|[TechAhead yazılım Pvt. Ltd.](http://www.techaheadcorp.com)|Princeton, NJ; Noida, Hindistan|Çalışma alanı dijital dönüşümünüzü hızlandırın, verimliliği artırmak, güvenliği zorlamak ve her yerden, dilediğiniz zaman çalışmaya insanların kendi seçtikleri mobility çözümleri oluşturuyoruz. Kurumsal modeliniz için en uygun taşınabilirlik çözümleri geliştirin ve marka perception, Pazar sızma, hizmet tümleştirmesi ve Müşteri beklentileri ile mükemmel resonate iş hedefleri.|
|[Yürüyen ağaç Danışmanlık Hizmetleri](http://www.walkingtree.in/)|Hyderabad, Hindistan|Ağaç walking teknolojisi, tutkularını için tanınan bir BT yazılım ve hizmet sağlayıcısıdır. Bunlar bir ürün geliştirme takımı veya arka uç mühendislik ekibi müşteriler için dünya çapında işlevi görür.|
|[Web örümcekler](http://www.webspiders.com)|New York, NY; Londra, İngiltere; Singapur; Hindistan|Web örümcekler (WS) ürün pazarlama geliştiren bir kurumsal yazılım şirketi olan ve sürücüsüne ik 'mobility ve yapay zeka destekli Botlar kullanarak kullanıcı etkileşimini' iletin.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Greenfinch teknolojisi](https://greenfinch.ie/)|Dublin, İrlanda|Yazılım Mühendisliği şirket yenilik & kalite üzerinde odaklanır. İşletmelerinin günümüzde hızla değişen bir dünyada zorlayan yardımcı olmak için bir tasarım, oluşturma ve yönetme hizmetle müşterilerimize sunuyoruz|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Cortis Lentini](http://www.cortislentini.com)|Milano, İtalya; Roma, İtalya; Bergamo; İtalya|Cortis Lentini provices yenilikçi altyapı ve teknik dış kaynak desteğinden yararlanan hizmetler|
|[Dataexpert S.r.l.](http://www.dataexpert.it)|Milano, İtalya|Dataexpert yenilikçi, hizmet odaklı ve mevcut teknoloji altyapıları, hızlı ve basit bir uygulama ile tümleştirmek kolay yüksek bir değerle BT hizmetleri sağlayan, bir liderdir|
|[Fabrika unutmayın](http://www.factorymind.com)|Trento, İtalya|Fabrika göz önünde bir takım ile bilgisayar Bilim, teknoloji ve yenilik için bir başlangıç tutkulu bir geliştirici oluşan bir genç ve dinamik Guyana ' dir.|
|[Beşinci Ingenium](https://fifthingenium.com/)|Milano, İtalya|İtalyanca bir BT şirket, mobil uygulamaları, bulut çözümleri ve gelişen teknolojiler özelleştirilmiş FifthIngenium olduğu|
|[Gaia S.r.l.](http://www.gaia.is.it/en/)|Milano, İtalya|Gaia kişiler için tasarlanmış dijital ekosistemlerini oluşturan bir deneyim tasarım şirketidir.|
|[Giuneco s.r.l.](http://www.giuneco.it/)|Floransa, İtalya|Şirket iş açısından önemli ölçüde dikkat (UX) kullanılabilirliğini ve bakım için etkili ve verimli çözümleri oluşturmak için (çoğunlukla Microsoft Dünya ilgili) yeni teknolojilerden yararlanmak için olan|
|[Lemcube](http://www.lemcube.com)|Paese, Treviso, İtalya|Danışmanlık şirketi ile 10 yıllık Microsoft .net deneyimini yaşayın. Müşterilerimizin sektörlerde, lojistik, Bakım ve mobilliğin. Danışmanlık ve eğitim işine sunuyoruz.|
|[Mahiz Srl](http://www.mahiz.it/)|İtalya|Artisans yazılım Mahiz bilişim alanındaki yirmi yıllar sağlayarak daha iyi ürünler oluşturması için yardımcı olur. Kendi iş açısından, ürün, süreçleri ve fikirleri gelişimi engelleyen bozuk yazılım dünyasına RID sağlamaktır. |
|[Proge yazılım](http://www.progesoftware.com)|Roma, İtalya; Milano, İtalya|Biz yüksek teknoloji içeriğiyle projeleri büyük ve orta ölçekli şirketler için talep ve uluslararası beri 1985 üretme. Tasarım, geliştirme ve kurumsal BT sistem bakımı için gereken tüm etkinlikleri sunuyoruz|
|[PS Mobil srl](http://www.psmobile.it)|Bologna, İtalya|PS Mobile'dan Nicolas felsefesi iletişim kutusu temel alır. Müşteri için dinleme ve birlikte bir strateji tanımlama. Bu başarılı olması, kullanıcılar, iş hedefleri ve platformlar tarafından sunulan olanaklar ihtiyaçlarını mutabık kılmak için gereklidir. Geliştirme takımlarının seçilmiş platformları belirli yönlerini dikkate grafik, teknoloji ve kullanıcı deneyimi ve gerçekleştirilen işlemlerin açısından mükemmel performans sağlar.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Diatom kuruluşlar](http://www.diatomenterprises.com/)|Riga, Letonya|Tek tek Web, mobil ve bizim istemcileri iş bireyselliğinizi gücünü büyük harfe çevirme masaüstü sistemleri geliştiriyoruz.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Bit çözümleri ve danışmanlık hizmetleri GmbH](https://www.bitsolutions.ch)|Balzers, Liechtenstein|Bit çözümleri ve danışmanlık hizmetleri geliştiren tek tek web, mobil ve Masaüstü uygulamaları|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[AGILUX](https://agilux.lu)|Pommerloch, Lüksemburg|Agilux ticari yönetimi için BT çözümlerinin tümleştirme uzmanlaşmış ve SMEs, Web siteleri, e-ticaret ve mobil uygulamalar geliştirmeyi hesap bir bilgisayar danışmanlık şirketi olan|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Kod Kimya](http://www.codechem.com)|Üsküp, Makedonya|Kod Kimya sağlayan yazılım geliştirme, proje yönetimi ve danışmanlık hizmetleri. |
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Alset](http://alset.com.mx)|Mexico City, Mexico|Bilgi teknolojisi (BT) içinde kapsamlı sektörler durumu resim, Gelişmiş, güvenilir ve güçlü çözümlerle sağlama deneyimi ile uzmanlaşmış bir şirkettir ALSET olduğu|
|[Gigigo grubu](http://www.gigigo.com)|Mexico City, Mexico; SAN Paulo, Brezilya; Madrid, İspanya|2004'te, bu yıl sırasında kurulan Gigigo bir düz ve güvenilir dijital ally, Yönlendirme ve büyük şirketlerin dijital dönüşüm doğrultusunda kendi yolundan eşlik eden özelliğine sahip oldu|
|[InfoTacto](http://infotacto.com)|Mexico City, Mexico|Risk yönetimi, sistem durumu, sosyal güvenlik (emeklilik planları ve sosyal avantajı düzenleri), kamu güvenliği, otel sektörü ve bilgisayar teknolojileri kapsamlı deneyimiyle uzmanları disiplinlere grubu duyuyoruz.|
|[Lisyx teknolojileri SA de CV](http://www.lisyx.com)|León, Guanajuato|Lisyx teknolojileri, bilgi teknolojisi ve iş süreçleri için çözümler üzerinde odaklı danışmanlık bir şirkettir. Danışmanlık Hizmetleri katma değerli iş ve BT dış kaynak Hizmetleri ve çözümleri gelişen sağlarlar.|
|[Migesa](http://www.migesa.com.mx/)|Monterrey Nuevo Leon, Meksika; Mexico City, CDMX, Meksika|Mevcut 35 yılı aşkın bir pazarda Migesa en büyük bilgi ve iletişim teknolojileri hizmet ve çözümler entegratörü biridir. Biz tasarlayıp Orta ve büyük şirketler ihtiyaçları için Üreticiler çözümler.|
|[RAMSCT SC](http://www.ramsct.com )|Mexico City|Cada empresa bir nivel mundial se encuentra actualmente evaluando la mejor manera de utilizar soluciones móviles dentro de su negocio. Nuestra experiencia tr soluciones móviles por más de 10 años numaraları permite ofrecer soluciones totalmente integradas incluyendo:  |
|[TotalTech SA de CV](http://www.totaltech.com.mx)||omos expertos tr desarrollo de uygulamaları para iOS, Android y Windows Phone. |
|[Xherstone](http://www.xherstone.com)|Naucalpan de Juárez, Meksika|Xherstone yazılım, web ve mobil geliştirme şirketi teknolojinin kişiselleştirme açık kaynak sınırları üzerinde çalışmakta olduğu. İş ve teknoloji deneyimi birleştirdik.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Çevik teknolojileri ](http://www.agiletz.com)|Dubai, Birleşik Arap Emirlikleri; Kuveyt; Umman; Bahreyn; Katar; Kahire, Mısır|Çevik teknolojileri olan kurumsal BT çözümleri sağlayıcısı danışmanlık, eğitim ve hizmetler DevOps, geliştirme ve test etme hizmetleri sağlar.|
|[CodeValue](http://www.codevalue.net)|Herzliya, İsrail; Yokne'am Illit, İsrail|CodeValue olan müşterilerin, çekirdek iş etkinliklerini odaklanmak yazılım hizmetleri, tam spektrumlu sunan önde gelen bir yazılım şirketi|
|[DCube](http://www.dcube.me/)|Riyad, Suudi Arabistan|Elektronik medya ve reklam Arap Internet dünyanın en iyi deneyimi üretim ve elektronik içeriği sağlamak için bir görev ile geliştirme DCube uzmanlaşmış|
|[DigiPresence](http://www.digipresence.net)|Dubai, Birleşik Arap Emirlikleri|Digi varlığı sağlar, yükler ve teknik destek ve bakım hizmetleri için genel Directorate İkametgahınızda Dışişleri-Dubai ve kendi yabancı merkezleri sağlar.|
|[TechSource LLC](http://www.techsource.ae/)|Dubai - Birleşik Arap Emirlikleri|Bizim Hizmetleri tümleştirme çözümleri, uygulama geliştirme ve Bakım ile arasındadır ERP, CRM ve işlevsel danışmanlık hizmetleri. Son birkaç yılda, Orta Doğu Pazar liderleri biz önemli performans geliştirmeleri teslim.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Sezar uzmanları](http://www.caesarexperts.nl/)|Utrecht, Hollanda|Sezar uzmanlar tasarlar, oluşturur, uygular ve güçlü, yenilikçi ICT çözümleri yönetir.|
|[Dalosy](https://dalosy.com)|Hendrik Ido Ambacht, Hollanda| Dalosy çeşitli şirketler ve sektörler zorlukları ve belirli gereksinimleri karşılayan mobil çözümler sağlar|
|[Elastique](https://www.elastique.nl/)|Hilversum, Hollanda|Elastique bir yenilikçi uygulama geliştirme şirkettir|
|[EsperantoXL](http://www.esperantoxl.nl)|Utrecht, Hollanda|Akıllı yazılım çözümleri geliştirirken EsperantoXL specialises. Kuruluşlar, verimliliklerini süreçlerinin kolaylaştırarak inovasyonu artırmak için yardımcı olabiliriz|
|[Finaps](https://www.finaps.nl/)|Amsterdam, Hollanda|Finaps Mendix, SAS, Xamarin ve kutusu gibi gelişmiş teknolojilerini kullanan yenilikçi BT çözümleri sunar.|
|[Serbest](http://www.freed.nl/)|Achtkarspelen, Hollanda|Serbest bırakılan developes web ve mobil uygulamaları iOS, Android ve Windows için |
|[Holygrow](http://www.holygrow.nl )|Capelle Großbritannien bey IJssel, Hollanda|Bizim yaratıcılıkla, Bilgi Bankası, deneyim ve tutkularını anlamlı dijital ürün oluştururuz. Şunlarla birlikte bunu dört inanmaktadır.|
|[i-Pulse Internet Solutions](http://www.i-pulse.nl)|Doetinchem, Hollanda|Ben-pulse hem de web, özel yazılım uygulama ve daha fazlasını oluşturur|
|[Ijsberg danışmanları](http://www.ijsbergconsultants.nl)|Amsterdam, Hollanda|İşletme tasarımı, strateji, yenilik, ürün geliştirme, müşteri yönlendirme veya iletişim işlemiyle ilgili olup olmadığını IJsberg excel kuruluşlara yardımcı olur. Tam tümleşik bir yaklaşım formulating tarafından bunu|
|[B.V. bilgisi desteği](http://www.infosupport.com)|Veenendaal, Hollanda; Mechelen, Belçika|Bilgisi desteği olan bir uzmanı geliştirme, yönetim ve özelleştirilmiş yazılım barındırma ve BI ve tümleştirme çözümleri sunmak|
|[iQuality](http://www.iquality.nl)|Nijmegen, Hollanda|Biz tasarlamak, geliştirmek ve yazılım, uygulamalar ve Web siteleri, müşterilerimizin amaçlarını göndermemeniz destekler. |
|[KEMBIT B.V.](http://www.kembit.nl/)|Wijnandsrade, Hollanda|Kapatıldığını izlenen gelişmeleri ve sonuçta elde edilen gereksinimlerini sayesinde tanıtır ve uygun, nitel, yenilikçi ve akıllı BT çözümleri farkında olun.|
|[KPN danışmanlık](https://www.kpnconsulting.nl/)|Zoetermeer, Hollanda|KPN'ın vizyonu, BT'nin teknoloji dağıtımını daha çok daha. İnsanlar ve kuruluş vigor artırma kendi önceliğe sahiptir.|
|[Logirix](http://www.logirix.com/en/)|Groningen, Groningen|Son kullanıcılar kuruluş işlemleri ve veri ile Bağlan kullanıcı dostu ve işlevsel arabirimleri Logirix sunar|
|[Macaw Nederland](http://www.macaw.nl)|Schiphol Rijk, Hollanda; Barendrecht, Hollanda; Apeldoorn, Hollanda|Macaw tasarlar, oluşturur ve office mobil, çevrimiçi ve giriş için dijital teknolojiden çözümleri yönetir. İş tümleştirmesi, Sosyal İşbirliği, bulut, pazarlama otomasyonu, İş analizi ve dış kaynak kullanımı alanında uzmanlarıyla değildirler.|
|[Yeni Nexus mobil](http://www.newnexusmobile.nl)|Amsterdam, BW|Tüm platformlar için hem iş ve tüketici uygulamaları yeni Nexus mobil çözümler oluşturur. Yeni Nexus mobil çözümler, kuruluşların süreç boyunca size yol gösterir: gerçekleştirme için danışmanlık ve uygulama bakımı için.|
|[Daire çözümleri B.V. açın](http://www.opencirclesolutions.nl/en/)|Eindhoven, Hollanda|Açık daire çözümleri, kişiler ve istemcileri, bilgi ve yenilik yoluyla başarılı hale getirmek için bir görev vardır. Bu işlem ve açık kaynak teknolojisini: iş uygulamaları, mobil uygulamalar, tümleştirme, iş zekası ve ürün geliştirme. Bunlar çoğunlukla PRINCe2 yöntemi izleyerek çalışan proje yöneticileri tarafından denetimli bir Çevik/Scrum yaklaşım tarafından sağlanan özel çözümleri inanıyoruz.|
|[Ordina ICT](https://www.ordina.com)|Nieuwegein, Hollanda; Groningen, Hollanda; Amsterdam, Hollanda; Eindhoven, Hollanda; Apeldoorn, Hollanda|Ordina istemcileri ile kurduğumuz iş ortaklığına sürdürülebilir yeniliklerini oluşturarak, görev açısından ulaşır. Bunlar istemcileri Kapat ilişkilerle taklit tarafından ulaşın. Bu karşılıklı güven ve anlama için yaptığı Yatırımlar başlar. Ancak, yalnızca bir başlangıçtır. Bunlar ilerletecek gerçek anlamda kolaylaştıracak sürdürülebilir çözümleri sunmak istiyorsunuz. Projeler ve fikirlerinin İsraf man saat ve ne bunlar yapmak için gereken ve yönetmek hangi sırayla kolay olan kaynaklar bir uzun ömrüne sahip oldukları anlamına gelir geliştirilmiştir.|
|[Noktası 42](http://www.point42.nl)|Reeuwijk, Hollanda|Akıllı telefonlar tr tabletler halen de gewone bilgisayarda aantal gebruikers s rap temposu içinde. Uitstekende gebruikservaring op mobiele apparaten hierdoor belangrijker dan ooit ' dir. 42 werkt altijd vanuit şil mobil-tr bulut öncelikli gedachte tr spitst zijn dienstverlening toe op duyarlı webdesign gelin.|
|[Hızlı daire BV](http://www.rapidcircle.com/)|Amsterdam, Hollanda; Pune, Hindistan; Melbourne, Avustralya|De digitale werkplek olan de vervanger van het bureaublad op de bilgisayar. De çevrimiçi echter altijd beschikbaar, ook op mobiele apparaten çeşididir. Voor de (mobiele) digitale werkplek rollen biz de standaard versie van Office 365; uit &. |
|[Redhotminute](http://www.redhotminute.com)|Tuil, Hollanda||
|[Rubicon](http://www.rubicon.nl/diensten/mobiele-apps)|Postbus 169, 4130 ED Vianen|Visie tot strategie dawid Van, tot uygulama geliştirme, tasarım integratie karşılanması testen, beheer tr bulut ERP. Wij hebben kennis tr karşılanıyor ervaring het bouwen van mobiele oplossingen zar passen bij uw individuele behoeften tr kansen dawid van. Rubicon ontwerpt, ontwikkelt, test, tr beheert uygulamalar dağıtılır. Onze 'Mobil DevOps-aanpak' zorgen karşılanıp biz voor şil voorspelbare, betrouwbare tr inzichtelijke ontwikkel tr beheeraanpak voor uw uygulamalar.|
|[Versluis](https://gerald.verslu.is/)|Sittard, Hollanda|Sağ miyim ağırlıklı olarak üzerinde focussing artık Xamarin ve her şeyi yöntemlerle özellikle uygulamaları oluşturma ile ilgilidir. Ancak, bir uygulamaya uygun arka uç, doğru tam değil? Bu nedenle, bazı ASP.NET (çekirdek) veya diğer web uygulamalarına korktuğunuz değilim. Ben ayrıca geçici olarak başka şeyler her türlü gibi tamir etmek ister: sürekli teslim ve her şeyi Azure, sürekli tümleştirme|
|[Xablu](http://www.xablu.com/)|Amsterdam, Hollanda|Uygulama Geliştirme ekibinizin geliştirme takımları derleyerek ve endüstri standardı geliştirme ortamları oluşturmak için birlikte kaynağını Xamarin uygulama geliştirme çözümleri ile Güçlendirin.|
|[Xpirit Nederland B.V.](https://xpirit.com)|Hilversum, Hollanda|Tutkulu teknolojisi uzmanları, iradeye sahip ve farklı işlemler yapmak üzere kullanabilirsiniz. Xpirit: Yenilikçilerinden, dönüştürme etkinleştiricilerden ve değişiklik benimseyen erken Benimseyenler. Yeni Microsoft teknolojisini uzmanlarının.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Enlighten yakında tasarımları](https://www.enlighten.co.nz)|Auckland, Yeni Zelanda|Enlighten yakında olağanüstü tasarlanmış, yenilikçi getirilecek var ve müşteri odaklı teknoloji çözümlerini sunmak. İOS, Android ve Windows için uygulama C# ' de oluşturmak için kullandıkları Microsoft teknolojileri|
|[Hydrogen uygulamaları Ltd](http://www.hydrogenapps.com)|Auckland, Yeni Zelanda|Başarıyla dünya çapında büyük ölçekli platformları sunulmasına deneyiminin aşkın yararlanarak, uygulamaları, taşınabilirlik ve oyun geliştirme yeni yaşı için bekleyen yazılım teslimini deneyime Hydrogen getirir|
|[Manyetik çözümleri Ltd](https://www.magnetismsolutions.com/)|Auckland, Yeni Zelanda; Christchurch, Yeni Zelanda|Bir başlangıç sağladığımız her CRM uygulaması müşterilerimize aldığımız. Birden fazla 1500 tanesi başarıyla başlatıldı, bizim farklı ve geniş Portföyünde arasında değişen çok gurur duyuyoruz. CRM uluslararası uygulamaya deneyimimizi, biz de CRM çözümünüze sağlamak yerleştirilen anlamına gelir. |
|[Zebra kesen](http://zebracrossing.co.nz/)|Taranaki, Yeni Zelanda|Teknoloji iş yeniliğe kullanırız. İçin dinleme, hedeflerinizi öğrenin ve gerekenler teslim biri ile iş ortağı.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Gelişmiş sistemleri teknolojisi](http://www.astechoman.com/)|Muscat, Umman|AstechOman BT çözümleri sağlayıcısıdır. |
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Haiyan grubu Inc.](http://www.haiyan.com.ph)|Manila, Filipinler|Haiyan grubu Inc. developes web ve mobil uygulamaları iOS ve Android için|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Applandeo](http://www.applandeo.com/en/)|Krakow, Polonya|Uygulama ve web geliştirme şirketi Applandeo olduğu|
|[ASSECO POLONYA GÜNEY AMERİKA](https://pl.asseco.com/)|Rzeszów, Polonya|Asseco Polonya teknolojik Gelişmiş yazılım çözümlerini şirketler ve kurumlar, ekonomi'nın tüm anahtar kesimlerini için 20 yıldan fazla geliştirdi|
|[Billennium](http://billennium.pl/)|Varşova, Polonya |Billennium yıllar boyunca yenilikçi iş araçları ve çözümleri geliştirme deneyimine sahiptir.|
|[Bir çözüm SP'yi z o.o. kenar](http://www.edge1s.com)|Varşova, Polonya |Becerileri ve yüksek oranda tam BT Danışmanı deneyimi sağlıyoruz. Portföyümüzün her hizmetin içinde müşteri gereksinimlerini ve beklentileri esnek bir yaklaşım ediyoruz|
|[NETBULLS SP'yi z o.o.](http://www.netbulls.io)|Bialystok, Polonya|Fikirlerinizi skilfully pazara alın. Harcanan £$ €, saat veya bahaneler. |
|[SII](http://www.sii.pl/en)|Varşova, Polonya; Paris, Fransa; Madrid, İspanya '; Berlin, Almanya; Amsterdam, Hollanda; Brüksel, Belçika; Lüksemburg Şehir, Lüksemburg; Geneva, İsviçre; Marrakesh, Fas; Prag, Czechia; Bükreş, Romanya; Toronto, ON, Kanada; Santiago, Santiago metropol bölge, Şili; Buenos Aires, otonom Buenos Aires Şehir, Arjantin; Bogota, Bogota, Kolombiya; Delhi, Hindistan|SII dijital dönüşüm programlar başarıyla teslim ve ötesinde, tasarlayıcılarla destekleyen önde gelen BT Hizmetleri Polonya içinde şirketidir. İlk cihaz iletişimi, büyük veri işleme ve çevrimdışı etkinleştirme kuruluş ve tüketici uygulamaları sunma konusunda uzmanlık sunuyoruz.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Agap2](http://www.agap2.com)|Lizbon, Portekiz|Agap2 – Avrupa işletimsel geliştiriciliğe ve sektörün özelleştirilmiş mühendislik grubu ve BT|
|[Karbon tarafından kalın](http://www.carbonbybold.com/)|Lizbon, Portekiz|Karbon kalın olarak şirket kendi iş stratejilerine mobil tümleştirme yardımcı olan mobil danışmanlık hizmetleri odaklanan bir marka olur. |
|[WIG](http://www.wig.pt)|Lizbon, Portekiz|WIG pozitif, organik ve özelleştirilmiş bir yaklaşımı vardır. İş ortakları istemciler görürler ve bizim gibi biz sorunlarını Canlı. Sonuç, pozitif, esnek, gerçek ve Pragmatik her zaman olur.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Binwell Ltd.](https://www.binwell.com)|St. Petersburg, Rusya|Binwell tasarlar ve özel yazılım iyi tasarlanan çözümlerine oluşturur. İş gereksinimlerini kullanmaya başlayın ve tam değeri biz istemciye her adımında Getir' anlama|
|[Notissimus](http://notissimus.com)|St. Petersburg, Rusya|Şirketiniz, satış veya hizmetler çalışır mı? Doğru yere Geldiniz. Yeni Proje her zaman büyük/küçük harf davetlidir. |
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[INSSIO](http://inssio.com)|Belgrad, Sırbistan|Uygulama sunum için proje conception iş fikirlerinizi INSSIO, işletmenizin yazılımına kapatır.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[CyanSYS](http://www.cyansys.com)|Singapur; Kuala Lumpur, Malezya; Makati, Filipinler; Hong Kong; Kota Kinabalu, Sabah, Malezya; Cakarta, Endonezya|CyanSYS etkinleştirmeden rekabet ve bilgi teknolojisi büyütün, küçük ve orta ölçekli şirketler için ölçeklenebilir ve kaliteli çözümler sağlayan üstlenmeye çalışır.|
|[Xamariners](http://xamariners.com/)|Singapur|İOS, Android, Windows ve Mac kolay Robotlar ve genişletilmiş gerçeklik uygulamaları yanı sıra, tek bir kod temeli ile yerel olarak çalışan uygulamaları ekleriz.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Logamic](https://www.logamic.com/)|Bratislava, Slovakya|Ekibiniz için ayrılmış bir Xamarin geliştiricisi eklemek istediğiniz veya bize veya bunu yalnızca Xamarin mobil geliştirme deneyimini Bize Ulaşın ücretsiz başvurmanız isterseniz tüm geliştirme işlemini kapsayacak şekilde istediğiniz olur. |
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[AD yazılım sistemleri](http://www.adsoftsystems.co.za)|Cape Town, Güney Afrika|AD yazılım sistemleri, özel Web ve mobil geliştirme çözümleri sunar. Bunlar yerel geliştirme üzerinde odaklanabilirsiniz, ancak ayrıca en fazla izin vermek için kolaylaştırıyor çözümleri arasında tüm önemli mobil platformlara yeniden|
|[CodeWrite Pty Ltd](http://www.codewrite.co.za/)|Johannesburg, Güney Afrika|Biz, mobil öncelikli uygulama ve web tabanlı çözümleri, özelleştirilmiş zengin Kurumsal yazılım uygulamaları ve güvenlik erişim denetimini sistem yazılım tümleştirme odaklanın|
|[Cyberlogic Pty Ltd](http://www.cyberlogic.co.za)|Cape Town, Güney Afrika|Cyberlogic bulutun bir yönetilen hizmet sağlayıcısı ve yönetilen veri merkezleri ile BT Hizmetleri|
|[Tam yığın](http://www.fullstack.co.za/)|Cape Town, Güney Afrika|Tam yığın veri ürünleri ve Hizmetleri süresi sabit bir fiyat karşılığında kaliteli yazılım teslimini aracılığıyla iş değeri elde tasarlanmış sağlayan bir yazılım şirketidir.|
|[Yeni ortam Laboratuvarları](http://www.newmedialabs.com)|Cape Town, Güney Afrika|Finansal Hizmetler istemciler için güvenli, işlemsel web uygulamalarında specialise. Bu özel sistemleri önemli geliştirmeler verimliliği ve müşterilerinin ilgisini olanağı sunmak için işletmeler bizim istemcileri ile tamamen tümleştirilmiştir.|
|[Paradigma grubu](http://www.paradigmgroup.co.za/)|Cape Town, Güney Afrika|Paradigma, uzman yazılım geliştirme bölme grubunda grubudur. Bunlar, şirket, NGO ve devlet kurumları için özel yazılım geliştirme yapın.|
|[Sabersoft danışmanlık](https://www.sabersoft.co.za/)|Güney Afrika|İşletmeler artık yeni pazarlara erişmek, tanınırlık kazanmanıza, hizmet sunumu geliştirmek ve sonuçta gelirlerini artırın mobil uygulamaların ödülünüzü alın.|
|[Tanjantı BT çözümleri](http://tangentsolutions.co.za/)|Güney Afrika |Eğim çözümleri, 2010'da kurulmuştur ve dijital dönüşüm geliştirme danışmanlık ev olur. Biz odaklı açık kaynak ve bir hızlı ilerleyebileceğiniz ve sürekli değişen teknolojik ekosisteminde katılan keyfini çıkarın. İlk bulut, DevOps ilk ve mobil ilk duyuyoruz. |
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[DevsDNA](http://www.devsdna.com)|Seville, İspanya|Başka bir şekilde faaliyet düşünüyorsanız ve oluşturma DevsDNA yazılım mümkündür. Ne yazık ki bizim Çağdaş society saydamlık, etik kurallara, ilkeleri ve moral compass eksik.|
|[KutirTech](http://www.kutirtech.com)|Malaga, İspanya  |13 yıldan biz alınan oluşturmaya ve web ve mobil uygulamaları küçük ve büyük ölçekli Kurumsal istemcileri için destek. Biz sürekli keşfedin ve en iyi sınıf Araçlar ve teknolojiler ile denemeler yapın ve araçları ve becerileri Kurumsal müşterilerimize başarılı hale getirmek için doğru bileşimini getirin.|
|[Pasiona S.L danışmanlık](http://www.pasiona.com)|Barcelona, İspanya|Şirket içi dinleme ve iletişim kutusunda, müşterilerimizin ile ilgi çekici kendi gereksinimlerine göre düzenlenen ve teknolojik yenilikçi çözümler sağlamak için en iyi yolu olduğundan emin ediyoruz 2007'de bulunmuş. Diğer bir deyişle görevimiz ve bizim raison d'Äôetre. Bir danışmanlık duyuyoruz uzmanlaşmış bir şirkettir her istemci farklıdır ve benzersiz ve özel işleme gerektirir çünkü her şirket için özelleştirilmiş çözümler geliştirmede. Yenilik, yüksek kaliteli iş, devam eden eğitim ve İnsan teaRegional Premier değerini kararlıyız|
|[TalentoMobile](http://www.talentomobile.com/)|İspanya |Dijital natives duyuyoruz. Biz, iş süreçleri ve müşterilerinizin, hem Çözümlerimiz ve Ürünlerimizin bağlantıyla dijitalleştirerek.|
|[Vass Consultoria de Sistemas](http://www.vass.es/en)|Madrid, İspanya '; Barcelona, İspanya|VASS BT kesin danışmanlık, 1999 yılında kurulan yeni teknolojileri ve tümleşik ürünleri ve Hizmetleri hakkında kapsamlı bilgi ve teknoloji mastery ile yüksek oranda özelleştirilmiş olur. Bir şirketin Avrupa'da ve Amerika bazı ülkelerde bulunan uluslararası genişleme için açık bir taahhüt değildirler. VASS society, %2 sosyal eylemlerine kar harcama taahhüdünde bir şirkettir.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[BITZEAL](http://www.bitzeal.se)|Gothenburg, İsveç|Web tabanlı uygulamalar, telefon ve Masaüstü uygulamaları ve üretici yazılımı Bitzeal yapar|
|[BT Conevo AB danışmanlık](http://www.conevo.se)|Stokholm, İsveç|Conevo, istemcileri işe, harika yanıtlama ile verimli ve humble bir şekilde en iyi ve en sürdürülebilir BT çözümleri oluşturma bir BT danışma şirketidir|
|[Dalgaları yapma](http://www.makingwaves.com)|Stokholm, İsveç|Dalgaları yapmadan stratejisi, tasarım uygular ve kuruluşların kalın yardımcı olacak teknoloji Hizmetleri başarılı dijital işletmeler dönüştürün. 300'den fazla yaygın ve nitelikli uzmanları ile dijital birinci olmak için ihtiyacınız olan her şeyi sunan bir yenilik iş ortağı oldukları.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Arendi](http://www.arendi.ch/)|Hombrechtikon, İsviçre|Arendi çeşitli hizmetleri sağlar: uygulama geliştirme, donanım ve üretici yazılımı geliştirme ve proje yönetimi |
|[BBV yazılım hizmetleri AG](http://www.bbv.ch)|Zürih, İsviçre|BBV yazılım hizmetleri, İsviçre yazılım ve danışmanlık şirketi olan. Bunlar, belirli ve karmaşık iş gereksinimlerinize yönelik mobil çözümleri geliştirebilirsiniz.|
|[Noser mühendislik AG](http://www.noser.com)|Winterthur, Zürih |Noser, özel geliştirme, mobil ve iş çözümleri için Microsoft Gold bir iş ortağıdır. Microsoft mühendislik Noser AG, bir Microsoft Gold sertifikalı iş ortağı, 2012 Microsoft uygulama yaşam döngüsü yönetimi (ALM) iş ortağı Ödülü kazanan birinciyi adlı. Ödül bu yenilikçi teknoloji çözümlerine ve ALM en iyi practise aracılığıyla yüksek kaliteli yazılım sunmaya bekleyen taahhüt tanır.|
|[Grup synapsis SPRL](http://www.synapsis-group.com)|Brüksel |Yazılım geliştirme ekibimiz, küçük ve büyük şirketler için başarılı üreticiler ve sabit fiyatlı geliştirmelerin uzun bir izleme kaydını sahiptir. Masaüstü, Web veya mobil platformda (iOS/Android/Win8) olup olmadığını, projenizle ilerlemek için ihtiyacınız olan tüm kaynakları sahibiz.|
|[TechTalk](http://www.techtalk.at)|Viyana, Avusturya; Zürih, İsviçre|Biz size en iyi yazılım geliştirme, kalite güvenliğini sağlarken zamandan ve paradan tasarruf getirin. |
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[iScreen Corporation](http://www.iscreen.com)|Taipei, Tayvan|iScreen danışmanlık, tasarlama ve Web uygulamaları ve herhangi bir mobil platform uygulamaları oluşturmak, iş odaklı, sağlam teknolojisini kendi foundation oluşturdu|
|[JetFusion bilgi Co., Ltd.](http://www.jetfusion.com.tw/)|Taipei|Biz yüksek oranda esnek, gerçek zamanlı ve Profesyonel yazılım geliştirme ve sistem yapı hizmetleri sağlamak ve ayrıca tam kurumsal bilgi sistemi çözümler sunar.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Hologramı LTD](http://hologramsoft.com/)|Istanbul, Türkiye|Birden çok platformda odaklanan bir Çevik Yazılım Geliştirme Merkezi, hem şirket içinde çalışma ve oyun alanı hologramı LTD olduğu|
|[Mobilist Bilisim Sistemleri](http://www.mobilist.com.tr)|Istanbul, Türkiye|Yenilikçi çözümler getirmek için yüksek kaliteli mühendislik ve akıllı tasarımları araya.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Uyarlamalı finansal danışmanlık sınırlı](http://weareadaptive.com)|Londra, Birleşik Krallık|Uyarlamalı finansal danışmanlığı bir geliştiriciliğe finansal endüstri kapsamlı bir deneyim ile sınırlıdır|
|[Apptelic Ltd](http://Apptelic.com)|Londra, Birleşik Krallık|Apptelic Ltd, iOS, Android, Windows ve Xbox One için mobil ve Masaüstü uygulamalar geliştirirken uzmanlaşan bir yazılım geliştirme şirketidir.|
|[AppXib Ltd](http://www.appxib.com)|Peterborough, Birleşik Krallık|AppXib bir uygulama geliştirme şirkettir|
|[Mavi Sparrow uygulamaları](http://www.bluesparrowapps.com/)|Bristol, Birleşik Krallık|Mavi Sparrow uygulamaları ödül kazanma Uygulama geliştirici şirket|
|[Chelsea uygulamaları Fabrika](http://chelsea-apps.com/)|Londra, Birleşik Krallık|CAF önde gelen bir Birleşik Krallık mobil uygulama geliştirme şirket olarak kendisi için bir ad ve ulus en büyük uzmanı mobil danışmanlık hem tüketici ve kurumsal uygulamaları için hızlı bir şekilde yaptı|
|[Kod oluşturulmuş Londra Ltd](http://getcodified.com/)|Londra, Birleşik Krallık|Londra, React Native ve Xamarin Ajans önde gelen|
|[Cohaesus](http://cohaesus.co.uk)|Londra, Birleşik Krallık|Cohaesus yerel uygulamalar bazı sektörün en iyilerinden yararlanmak için en büyük markaların, iOS, Android ve Windows telefonlar tüm teslim edilen oluşturur|
|[Contemi](http://www.contemi.com)|Lysaker, Norveç; Okuma, Birleşik Krallık|BT geliştirme ve yazılım için ve başlatma girişimlerini ile geliştirme iş geliştiriciliğe firması Contemi olur.|
|[Creative Bilimleri](https://creativesciences.co.uk)|Londra, Birleşik Krallık|Creative Bilimleri sağlar, mobil ve web geliştirme konusunda danışmanlık, desing ve Destek Hizmetleri. |
|[Datadruid](http://www.datadruid.co.uk)|Güneş'ın Stortford, Birleşik Krallık|Güçlü, yüksek performanslı uygulamalar ve geliştirme Hizmetleri sunuyor. Hızlı ve uygun fiyatlı bir şekilde teslim|
|[Eastpoint yazılım](https://www.eastpoint.co.uk/)|Londra, Birleşik Krallık|Stratejisi ve planlama, tasarım ve UX, geliştirme, test ve Bakım ve destek sağlayan bir hizmet Geliştirme Merkezi duyuyoruz|
|[Kırk dokuz öğesi](http://www.elementfortynine.com)|Londra, Birleşik Krallık|Kırk dokuz apps'de odaklanan bir mobil geliştiriciliğe öğedir, içinde platformlar mobil geliştirme specialising ve kod talimatın, kullanıcı deneyiminin en önemli önceliktir sağlama artırabileceksiniz yeniden|
|[Everis](http://www.everis.com)|Londra, Birleşik Krallık|İş ve stratejik çözümleri, geliştirme ve Bakım teknolojik uygulama ve dış kaynak hizmetlerin sunduğu çok uluslu bir danışmanlık şirketi Everis olduğu|
|[Fujitsu](http://www.fujitsu.com/uk/services/application-services/application-development-integration/)||Fujitsu tam bir dizi teknoloji ürünlerinin, çözümleri ve hizmetleri sunan önde gelen Japonca bilgi ve iletişim teknolojisi (ICT) şirkettir|
|[Futurice](http://futurice.com)|Londra, İngiltere; Münih, Almanya; Helskinki, Finlandiya|2001 beri Futurice 200'den fazla müşterilerle bin tane projeler üzerinde çalışmıştır. Yenilikçi fikirlerinizi oluşturmak ve bunları uygun yazılıma dönüştürmenize nasıl alışık oldukları|
|[Grove grubu](http://www.groveis.com/)|Londra, İngiltere; Johannesburg, Güney Afrika|Grove size işletmenizin başarısını teknolojisi aracılığıyla açığa çıkarın. Siz ve işletmeniz potansiyelinizi öncü bulut bilgi işlem, özel yazılım geliştirme, siber güvenlik ve analiz gücüyle karşılamak yardımcı olabiliriz|
|[Guimak Ltd.](http://www.guimak.com)|Londra, Birleşik Krallık|Oyun Geliştirme şirketi|
|[İçinde elle Ltd](http://inthehand.com )|Newport, Shropshire, Birleşik Krallık|Uygulamaları ve bileşenleri mobil, karma gerçeklik ve IOT sistemlerinde el Ltd. oluşturur|
|[iOS BITS](http://iosbits.co.uk)|Londra, Birleşik Krallık|iOS mobil yenilik etkinleştiricilerden bittir. Güçlü kullanıcı deneyimleri ve yeni çıkan teknolojiler aracılığıyla creative iş araçları nasıl oluşturulacağı alışık oldukları|
|[iScientia sınırlı](http://www.iscientia.co.uk/)|Surrey, Birleşik Krallık|Bilgi sistemleri geliştiriciliğe ve çoğunlukla Konaklama, perakende ve ödeme sektör çözümleri sunuyoruz.|
|[Mikrosaniye](http://www.microsec.co.uk/)|Hampshire, Birleşik Krallık|Son üç teknolojilerinden mikrosaniye tasarlanan, geliştirilen ve yazılım çözümlerini genel kullanımda neredeyse her teknolojisi kullanılarak desteklenir.|
|[Motech Ltd.](http://www.motechltd.com)|Londra, İngiltere; Riga, Letonya|Motech Ltd Kurumsal mobil çözümleri 12 + yıl uzmanlığı Kurumsal Mobile Apps en iyi değer sağlamak küresel şirketler için Kurumsal uygulamaları teslim yararlanarak bir Uluslararası teknoloji şirketi olan|
|[Piksel yönetim Ltd](http://pml.co.uk)|Solihull, Batı Midlands, Birleşik Krallık|Projeleri PML'ın enterprise, ticari ve eğitim uygulamaları eklediniz. Birden fazla programlama dili, yerel mobil ve bulut geliştirme, şirketin temel uzmanlıklar yayılan karmaşık güvenlik sistemleri hala görüntü, video sıkıştırma ve akış. |
|[Proto yazılım](https://www.protosoftware.co.uk/)|Birleşik Krallık|Biz platformlarını iOS, Android ve Windows 3 milyardan fazla potansiyel müşteriye ulaşabileceği vermek dahil olmak üzere çeşitli iş için mobil uygulamalar geliştirebilirsiniz. |
|[Nadiren imkansız](http://www.rarelyimpossible.com)|Bournemouth, Birleşik Krallık|Nadiren imkansız Yardım şirketler mobil uygulamalar oluşturun ve IOT bulut çözümleri hem tasarım ve geliştirme aşamaları sırasında kullanıcı deneyimine odaklanan iş sorunlarını çözmek için. Projeler ve müşterilerimizin oluştururuz ürünler aracılığıyla Hedefimiz, her gün içinde yardımcı olacak araçlar ile bir kuruluş içindeki herkes güç katın sağlamaktır.|
|[Rock düz bilgi](http://www.rocksolidknowledge.com)|Bristol, Birleşik Krallık|Xamarin iş ortakları yapı platformu çözümleri mobil iOS ve Android üzerinde hem Xamarin.Forms hem de yerel UI kullanarak çapraz olarak. Yerel UI düşündüğünüz tüm paylaşırken veya platformlar arasındaki kod harika bir işlem teslim etme çözümleri geliştirirken deneyimli duyuyoruz.|
|[Screenmedia](http://www.screenmedia.co.uk)|Glasgow, Birleşik Krallık|İstemciler ve son kullanıcılar için İnsan centred çözümleri oluşturmak için bir insan centred iş olmaları gerekir, Screenmedia inanmaktadır. Kendi görme ve değerler tamamen yansıtan ve doğal olarak, bu nedenle bunların yaptığı. Screenmedia'nın uygulama kültürü başarılarını anahtarıdır. Bu ' ne sürücüleri ve yeni çıkan teknolojiler; bunların sürekli yeniliğe arızayı Äôs yardımcı olur, istemcilerle Çevik iş ortaklıkları oluşturur. ve ' kılan çok zor Äôs keyifli çalışma.|
|[Sequence](https://www.sequence.co.uk/)|Cardiff "," UK "; Londra, Birleşik Krallık|1995'te oluşturulan yaratıcı bir dijital Ajans sırasıdır. Tasarım, stratejisi ve kullanıcı deneyimi specialising, bunlar bazı sektörde seyahat ve Turizm için üretim'den arasında değişen büyük kuruluşlar Krallık çalıştı. Tutkunuzu ve yenilik yoluyla müşterilerle birlikte markaları bağlanılıyor.|
|[ShinobiSolutions](https://www.shinobicontrols.com/shinobienterprise)|Newcastle upon Tyne, Birleşik Krallık|2011'de, en başından beri iOS ve Android geliştiricileri için kapsamlı ve güçlü etkileşimli kullanıcı Arabirimi denetimleri Shinobicontrols katıldığımdan. 2012 tarafından shinobicharts, ilk ürün başlatıldığında. O tarihten sonra bunlar ' Äôve hızla büyütmüş ve artık binlerce müşteri hızla genişleyen portföyümüzün ürünleri ile UI çözümleri sağlamak.|
|[Skillweb](http://www.skillweb.co.uk)|Yüksek Wycombe, Birleşik Krallık|Skillweb mobil işgüçlerini yönetmek ve kullanıcıların mal hareketlerini izlemek kuruluşlar yardımcı olmak için tasarlanan teknoloji çözümlerini sağlayan özel mülkiyete ait, Birleşik Krallık tabanlı bir iştir. Şirket dağıtımları 1999 yönetmeyi itibaren Birleşik Krallık ve Avrupa'da çalıştırılan ve her ay en fazla 100 milyon işlem sorumlu ve giderek büyüyen.|
|[Yazılım çözüldü](http://www.softwaresolved.com/)|Exeter "," UK "; Londra, İngiltere; Manchester, Birleşik Krallık|Güven ve bekleyen yazılım teslimini göre müşterilerimizin ile uzun süreli iş ortaklıkları ekleriz. Bir Microsoft Gold iş ortağı duyuyoruz ve ISO sertifikalı 9001 bizim işlemlerdir.  Bu, size en yüksek kalite standartlarını yazılım geliştirme ile akredite anlamına gelir.|
|[StyleTech](https://www.styletech.co.uk/)|Kabuk, Birleşik Krallık|Uzmanlarıyla özel yazılım ayrıca destekleyen korumak ve eski sistemler geliştirme sırasında müşterilerimizin Äô gereksinimlerine uyacak şekilde son teknoloji ürünü, özel olarak uyarlanmış çözümleri geliştirme duyuyoruz. 1999'dan beri işletim, biz hem genel hem de özel kesimler istemciler farklı bir dizi için 1000'den özel yazılım projeleri sunmak bir izleme kaydını özelliğine sahiptir, biz sağlık, Bilimsel, taşıma, üretim ve teknoloji sektörler specialise. Bir ulaşılabilirdir ve kolay kültür ile her zaman bir odaklanmış, hizmet kalitesi tüm müşterilerimize sunuyoruz. Xamarin, Xamarin Test Bulutu ve Azure uzmanlarıyla mobil duyuyoruz çalışma, tablet, bulut, web veya masaüstü geliştirme ve her zaman en iyi analiz, tasarım, güvenlik, test ve tümleştirme alanlarına uygulayın.|
|[Superluminal](http://www.superluminalsoftware.co.uk)|Oxford, Birleşik Krallık|Biz oluşturma işlemi ve hiper kaydedilecek işletmenizi hizalama kritik sistemleri yazılımımızı baştan tasarlama için burada Superluminal yazılım mühendisleri duyuyoruz. Biz ayrıca korumak ve geçerli sisteminizi yükseltme engellemesini kendi başlangıç veya ile işletme ihtiyaçlarını karşılamak için değişiklik gerektirir.|
|[Özel uygulama şirket sınırlı](http://www.thebespokeappcompany.co.uk)|Barrowford "," UK "; Kuzey Batı Leicestershire bölge, Birleşik Krallık||
|[Thumbmunkeys Ltd](http://www.thumbmunkeys.com)|York, Kuzey Yorkshire, Birleşik Krallık|Bir parça 30 milyon indirme ile tüketici uygulamaları oluşturma içeren kayıt ile Thumbmunkeys gerçekten olağanüstü ve kullanıcı ilgi çekici mobil deneyim oluşturmayı biliyorsanız. Sunduğumuz Birleşik Krallık takım Uzman geliştiricilerden oluşan temel alır ve tasarımcılar prototip oluşturma, UI/UX tasarımı, platformlar arası geliştirme, bulut geliştirme ve devam eden teknik destek danışmanlığı özel olarak uyarlanmış bir uçtan uca bir çözüm sunar.|
|[VoxDev Ltd](http://www.voxdevmobile.com)|Durham, Birleşik Krallık|VoxDev 2003'te oluşturulmuş ve Kuzey Doğu of İngiltere'deki Durham, bizim tabanından biz başarıyla istemcileri ile yazılım projeleri oluşturma, Web sitesi tarafından yardımcı Masaüstü ve mobil uygulamaları.|
|[Waterstons LTD](https://waterstons.com)|Durham, Birleşik Krallık|Daha iyi bir iş oluşturun. Teknoloji, deneyim ve taahhüt, işlerini artırmak için istemcileri, büyük ve küçük, yüzlerce ile Waterstons çalışır.|
|[BT Genişlet](http://www.xpand-it.com)|Lizbon, Portekiz; Londra, Birleşik Krallık|İle birkaç yıl mobil dünya ve 130'den fazla mobil uygulamalarda kullanılabilir farklı marketlerden deneyiminin Genişlet BT Kurumsal mobil uygulamalar hizmetlerde bir liderdir.|
|[YARG sınırlı](http://www.yarg.com)|Londra, Birleşik Krallık|YARG geliştiren platformlar arası mobil uygulamaları iPhone, iPad, Android ve Windows Phone. Bunlar kendimize değer, ürün kalitesini ve yüksek düzeyde kişisel hizmet sağlamaya gurur.|
|[Zepto sınırlı sistemleri](http://www.zeptosystems.com )|Londra, Birleşik Krallık|Dış kaynak kullanımı ve akıllı kaynağını belirleme için offshoring dönüştürme. (% 60 varan), zamandan tasarruf maliyet şirket içi kapasite ve uzak çalışanlar ile becerilerinizi artırın işe alma ve koruma.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[FreezePro yazılım](http://freezeprosoftware.com)|Lviv, Ukrayna|FreezePro özel yurtdışında yazılım geliştirme ve dış kaynak kullanımı şirket yazılımdır. Güçlü BT arka planlar ile uyanık uzmanları tarafından kuruldu.|
|[GUI yeniliklerini sınırlı](http://www.gui-innovations.com)|Kiev, Ukrayna|Mobil bir dünyada için yazılım çözümleri sunuyoruz. Sahip olduğumuz tasarlama, geliştirme ve destek yazılımı için birçok platformda rakipsiz uzmanlığı|
|[Neadevis](http://neadevis.com/)|Lviv, Ukrayna|Müşteri memnuniyetini ve yüksek kaliteli çözümler işletmemize temellerini var. Bizim Upwork istemcilerinde müşterisine mükemmel geri bildirim puanları bulunun. İstemciler hakkında bize görüşlerini hakkında daha fazla bilgi edinin.|
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[Nareia](http://nareia.com.uy)|Uruguay|Mobil bir dünyada için tutkulu duyuyoruz, iOS ve Android için harika uygulamalar oluşturmaya Sevdiğimiz gerçekten ve Xamarin ile mobil geliştirme hakkında harika bir deneyim sunuyoruz.  |
...
| İş ortağı | konumları | Açıklama |
| --- | --- | --- |
|[DVLUP](http://www.dvlup.net/)|Ho Şi Min Kenti, Vietnam|Geliştirme yukarı düzey yukarı Vietnam geliştiriciler için görev ile geliştirme topluluk liderleriyle tarafından kurulmuştur|
|[FPT yazılım Hanoi şirket sınırlı](http://www.fpt-software.com/)|Hanoi, Vietnam|Vietnam en büyük ve en hızlı gelişen dijital dönüşüm Hizmetler Sağlayıcısı.|
