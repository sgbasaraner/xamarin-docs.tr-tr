...
description: Bu belge, .NET katıştırma Java ile kullanmaya başlamak açıklar. Sistem gereksinimleri, yükleme ve desteklenen platformlar açıklanır.
ms.prod: xamarin
...
Kullanabileceğiniz [Mac için Visual Studio](https://visualstudio.microsoft.com/vs/mac/) düzenleyin ve C# kodunuzu derleyin.
