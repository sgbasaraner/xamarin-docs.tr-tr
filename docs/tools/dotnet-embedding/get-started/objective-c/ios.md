...
description: Bu belge, .NET katıştırma iOS kullanmaya başlamak açıklar. Gereksinimleri açıklanır ve yönetilen bir derleme bağlama ve çıktıyı bir Xcode projesini nasıl kullanılacağını göstermek için örnek bir uygulama gösterir.
ms.prod: xamarin
...
* [Xamarin.iOS 10.11 sürümünü](https://visualstudio.microsoft.com/xamarin/) veya daha yenisi
