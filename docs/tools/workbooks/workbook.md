...
description: Bu belge Xamarin çalışma kitaplarını denemeler öğretme, eğitim veya keşfetmek için C# kodunu içeren Canlı belgeleri oluşturmak için nasıl kullanılacağını açıklar.
ms.prod: xamarin
