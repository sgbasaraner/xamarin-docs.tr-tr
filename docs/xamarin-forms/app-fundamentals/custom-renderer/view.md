...
description: Bu makalede Önizleme video akışına cihazın kameradan görüntülemek için kullanılan bir Xamarin.Forms özel denetim için özel Oluşturucu oluşturma açıklanmaktadır.
ms.prod: xamarin
