...
Varsa da sunan [yaşam döngüsü yöntemleri](~/xamarin-forms/app-fundamentals/app-lifecycle.md) gibi `OnStart`, `OnSleep`, ve `OnResume` kalıcı gezinti olaylarını yanı sıra.
