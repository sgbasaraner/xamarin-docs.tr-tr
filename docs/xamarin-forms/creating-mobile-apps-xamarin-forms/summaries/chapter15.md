...
[![Üçlü ekran görüntüsü R G B kaydırıcılar](images/ch15fg03-small.png "RGB kaydırıcılar")](images/ch15fg03-large.png "RGB kaydırıcılar")
...
- [Giriş](~/xamarin-forms/user-interface/text/entry.md)
- [Düzenleyicisi](~/xamarin-forms/user-interface/text/editor.md)
