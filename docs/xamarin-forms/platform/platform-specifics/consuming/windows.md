...
Evrensel Windows platformunda, platforma özgü aşağıdaki işlevleri Xamarin.Forms görünümleri, sayfalar ve düzenleri için sağlanır:
...
Evrensel Windows Platformu (UWP üzerinde), platforma özgü aşağıdaki işlevleri için Xamarin.Forms görünümleri sağlanır:
...
Evrensel Windows platformu için Xamarin.Forms sayfaları aşağıdaki platforma özgü işlevleri sağlanır:
