...
description: Eski Xamarin.Forms çözümleri (veya üzerinde macOS oluşturulanlar) Evrensel Windows platformu projelerin sahip olmaz ve böylece bu makale varolan Xamarin.Forms çözümünü yeni bir UWP projesi ekleme açıklanmaktadır.
ms.prod: xamarin
