...
description: Bu makalede Xamarin.Forms kullanarak uygulama geliştirme ile ilgili temel bilgileri inceler. Kapsanan konular, bir Xamarin.Forms uygulaması, mimari ve uygulama temelleri ve kullanıcı arabirimi anatomisi dahil.
ms.topic: quickstart
ms.prod: xamarin
