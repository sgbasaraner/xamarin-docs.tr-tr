...
description: Bu makalede SkiaSharp üç farklı yolla yaylar tanımlamak için nasıl kullanılacağını açıklar ve bu örnek kodu ile gösterir.
ms.prod: xamarin
