...
## <a name="windows-installationandroidget-startedinstallationwindowsmd"></a>[Windows yükleme](~/android/get-started/installation/windows.md)
...
## <a name="android-emulator-setupandroidget-startedinstallationandroid-emulatorindexmd"></a>[Android öykünücüsünde Kurulumu](~/android/get-started/installation/android-emulator/index.md)
