...
description: Hata ayıklama günlüğü Xamarin.Android uygulamalarda hata ayıklama için nasıl kullanılacağını.
ms.prod: xamarin
...
-   Android öykünücüsünde çalışır bir Android sanal cihazı. 
